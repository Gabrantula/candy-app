...
export function appEditValidator(): ValidatorFn {
  
  const regExp= new RegExp(`(https?:\/\/.*\.(?:png|jpg))`)
  ...
  //const regExp = new RegExp(`^(http(s):\/\/.)[-a-zA-Z0-9@:%._\\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\\+.~#?&//=]*)$`);
